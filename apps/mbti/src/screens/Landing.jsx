  ...
  return (
    <div className="purpose-wrap">
      <div className="purpose-panel">
        ...
        <h1>แบบประเมินนี้ช่วยให้เราเข้าใจสไตล์การทำงานของคุณ</h1>
        <p className="purpose-lead">
          คุณจะได้ตอบสถานการณ์จำลองเกี่ยวกับการมอบหมายงาน การสื่อสาร การให้ฟีดแบ็ก และการทำงานร่วมกัน ในแต่ละข้อ ให้เลือกคำตอบที่ใกล้เคียงกับวิธีคิดหรือวิธีที่คุณจะทำจริงมากที่สุด ไม่มีคำตอบที่สมบูรณ์แบบ
        </p>
